    ...
    special: { // Extra abstractions, looking to future (easier to rewrite this file than every call to it)
      health: {
        init: function () {
          ...
          var firstHalfCardsView = new AA3.HEPASpecialReportCardsView({
            getQuestions: getAllCurrentQuestions,
            getCategory: getCategory,
            getState: getState,
            keys: ['children_in_afterschool', 'healthy_eating'],
            el: '.cardsWrapper.firstHalfCards'
          });

          var secondHalfCardsView = new AA3.HEPASpecialReportCardsView({
            getQuestions: getAllCurrentQuestions,
            getCategory: getCategory,
            getState: getState,
            keys: ['physical_activity', 'public_support'],
